        ...
        >
            <div ref="scrollContainer" class="overflow-auto flex-1">
                <ul>
                    ...
                    >
                        <inertia-link
                            class="block py-4 px-6 bg-white group focus:outline-none hover:outline-none"
                ...
                <div
                    ...
                    class="py-4 px-6 text-center bg-white"
                >
                    Loading...
                </div>
            </div>
            ...
            <div class="flex justify-between items-center px-6 mt-8 sm:px-0">
                ...
                <button
                    class="py-3 px-6 text-lg font-semibold text-white bg-indigo-500 rounded shadow-md focus:outline-none focus:ring focus:ring-indigo-400 focus:ring-opacity-50"
                >
                    + Create Form
                </button>
            </div>
